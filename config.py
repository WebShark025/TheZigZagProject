...
SUPPORT_GP = 1001025366893 # MAIN SUPPORT GROUP FOR ALL PMS TO GET FORWARDED.(such as messanger)
REPLIER = True # Lol.. a simple reply-to-message system xD (using dictionaries)
GP_GREETING_MSG = True # WELCOME MESSAGE TO ALL NEW MEMBERS
GP_FAREWELL_MSG = True # LEAVE MESSAGE
